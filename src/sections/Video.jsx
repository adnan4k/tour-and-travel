...
const EnjoymentVideo = () => {
  ...
  return (
    <section className="bg-white py-3 dark:bg-dark flex justify-center">
          ...
          <div className="w-full px-4 lg:w-10/12">
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              <div className="absolute left-0 top-0 h-full w-full">
                <img
                  src="assets/photos/video_image.jpg"
                  alt="bg"
      ...
      {videoOpen && (
        <div className="fixed left-0 top-0 mx-auto z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
          <div className="mx-auto w-full max-w-screen-2xl  bg-white">
            <>
              <iframe
                className="h-[320px] w-full"
                src="https://www.youtube.com/embed/RatnnQpA2FM?si=KpdXujTpQlCmT_Ua"
              />
            </>
          </div>
          ...
          <button
            ...
            className="absolute inset-x-0 top-0 flex h-20 w-20 cursor-pointer items-center justify-center text-body-color hover:bg-black"
          >
