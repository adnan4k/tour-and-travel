...
function Package() {
    return (
        <div>
            ...
            <div className="grid grid-cols-6 gap-4 mx-auto items-center min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200 p-4">
                {[...Array(3)].map((_, index) => (
                    <div
                        key={index}
                        className="col-span-2 gap-6 max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden transform transition duration-500 hover:scale-105">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                Immerse yourself in the tranquil landscapes and breathtaking vistas of the natural
                                world.
                            </p>
