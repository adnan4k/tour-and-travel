...
const testimonials = [
    {
        ...
        rating: 5,
        content: "This is an amazing service. Highly recommend it!",
    },
    {
        name: "John S",
        role: "Manager",
        ...
        rating: 4,
        content: "Great support and great features!",
    },
    {
        name: "Alice B",
        role: "Developer",
        ...
        rating: 5,
        content: "This platform has changed the way we work!",
    },
];
                                    ...
                                    {testimonials.map((item, index) => (
                                        ...
                                        <div class="swiper-slide group bg-white border border-solid border-gray-300 rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6 transition-all duration-500 hover:border-indigo-600">
                                            <div class="flex items-center gap-5 mb-5 sm:mb-9">
                                                <img class="rounded-full object-cover" src={item.avatar} alt="avatar" />
