    ...
    <section className="py-14">
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className=" mx-auto lg:w-2/5">
          <h2 className="text-3xl font-bold text-gray-900 leading-[3.25rem] mb-8">
            Customers{" "}
        ...
        <div className="flex flex-col justify-center items-center gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8 max-w-sm sm:max-w-2xl lg:max-w-full mx-auto">
          <div className="w-full lg:6/7">
              ...
              {testimonials.map((item, index) => (
                ...
                >
                  <div className="flex items-center gap-5 mb-5 sm:mb-9">
                    <img
                      className="w-28 h-28 rounded-full border-2 border-purple-500"
                    ...
                    <div className="grid gap-1">
                      ...
                      <span className="text-sm leading-6 text-gray-500">{item.role}</span>
                    </div>
                  </div>
